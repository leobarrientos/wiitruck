...
actions = {
    cwiid.BTN_A:    robot.forward,
    cwiid.BTN_B:  robot.backward,
    cwiid.BTN_LEFT:  robot.left,
    cwiid.BTN_RIGHT: robot.right,
}
...
while True:
    ...
    if (buttons & cwiid.BTN_A):
        ...
        action = actions.get(cwiid.BTN_A)
    ...
    if (buttons & cwiid.BTN_B):
        ...
        action = actions.get(cwiid.BTN_B)
        if action is not None:
            action()
        time.sleep(button_delay)
